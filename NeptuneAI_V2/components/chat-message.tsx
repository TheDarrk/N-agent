      ...
      {isUser ? (
        ...
        <div className="flex items-start gap-3 max-w-[88%]">
          ...
          <div className="flex-1 space-y-3">
            ...
            {message.action?.startsWith("SIGN_") && message.action?.endsWith("_TRANSACTION") && message.payload && (
              <button
              ...
              >
                ...
                {message.action === "SIGN_EVM_TRANSACTION"
                  ...
                  : message.action === "SIGN_TRANSACTION"
                    ? "Sign & Execute Transaction"
                    : `Sign ${message.action.replace("SIGN_", "").replace("_TRANSACTION", "")} Transaction`}
