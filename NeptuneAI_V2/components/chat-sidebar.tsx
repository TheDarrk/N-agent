...
import AutonomyDashboard from "./autonomy-dashboard";
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-3 pt-5">
                      ...
                      return (
                        <div key={tokenKey} className="flex items-center justify-between p-1.5 rounded-lg bg-card/30 hover:bg-card/50 transition-colors">
                          <div className="flex items-center gap-2">
                            {logoUrl ? (
                              <img src={logoUrl} alt={symbol} width={14} height={14} className="rounded-full flex-shrink-0" crossOrigin="anonymous" />
                            ) : (
          ...
          {/* ═══ v2 Autonomy Dashboard (additive — new section) ═══ */}
          <div className="mt-5">
            <AutonomyDashboard accountId={accountId} />
          </div>
        </div>
